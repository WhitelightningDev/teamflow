  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
      {Array.from({ length: items }).map((_, i) => (
        <div key={i} className="rounded-2xl bg-white dark:bg-neutral-900 border border-black/5 dark:border-white/10 shadow-sm p-4">
          ...
          <div className="mt-4 space-y-2">
            <Skeleton className="w-20 rounded">
              <div className="h-7 w-20 rounded bg-default-300" />
            </Skeleton>
